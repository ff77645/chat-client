        ...
        <div className="flex justify-center items-center h-full">
            ...
            <form noValidate="" action="" className="space-y-12">
                ...
                <div className="space-y-2">
                    <div>
                        <button onClick={()=>navigate('/chat')} type="button" className="w-full px-8 py-3 font-semibold rounded-md dark:dark:bg-violet-400 dark:dark:text-gray-900">Sign in</button>
                    </div>
